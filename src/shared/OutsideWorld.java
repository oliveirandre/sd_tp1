...
public class OutsideWorld implements ICustomerOW, IManagerOW {
	...
	/**
	 * Customer's method. After going back to work by car (with replacement car),
	 * the customer waits for the manager to tell him that his car has been repaired.
	 */
	@Override
	 ...
	 * @return a boolean representing if the customer is ready to pick up the car
	 */
	@Override
