...
public class SupplierSite implements IManagerSS {
	...
	/**
	 * SupplierSite constructor. Initializes the array containing
	 * pieces bought by the manager over time.
	 * 
	...
	/**
	 * Method used for log. Retrieves the total number of pieces bought 
	 * by the manager for each type of piece.
	 * 
	 * @return an Array with the total number of pieces bought for each type of piece
	 */
